    ...
    <section id="como-funciona" className="relative py-16 sm:py-24 bg-navy-light/30">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        >
          ...
          <p className="mt-4 text-muted-foreground">Três passos para escalar suas contas no <span className="text-red-500 font-semibold">Tik</span><span className="text-foreground font-semibold">Tok</span>.</p>
        </motion.div>
