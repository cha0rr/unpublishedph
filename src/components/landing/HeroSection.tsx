      ...
      <div className="relative mx-auto grid max-w-7xl gap-8 px-4 sm:px-6 py-12 sm:py-20 lg:grid-cols-2 lg:gap-16 lg:py-28">
        ...
        >
          ...
          >
            ...
            <span className="text-xs text-muted-foreground">Vídeos com IA para <span className="text-red-500 font-semibold">Tik</span><span className="text-black font-semibold">Tok</span> — Geração Ilimitada</span>
          </motion.div>
          ...
          <p className="mt-4 sm:mt-6 max-w-lg text-base sm:text-lg leading-relaxed text-muted-foreground">
            Crie UGC, vídeos virais de cartomante, fazendeiros, frutas falantes, notícias e muito mais para escalar contas no <span className="text-red-500 font-semibold">Tik</span><span className="text-black font-semibold">Tok</span>.
          </p>
